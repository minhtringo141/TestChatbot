...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText) {
      ...
      default:
        sendTextMessage(senderID,"Your Message is " + messageText);
    }
...
function receivedPostback(event) {
  ...
  if(payload == 'get_started'){
    sendTextMessage(senderID, "You've pressed Get Started");
  }else{
